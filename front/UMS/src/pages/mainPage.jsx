  ...
  return (
    ...
    <div className='relative w-full h-screen flex flex-col items-center '>
      ...
      {/* <div className='relative mt-3 z-10 p-3 max-w-lg mx-auto bg-white bg-opacity-75 rounded-lg '>
        ...
        <div class="flex  items-center justify-center bg-black mt-24">
          <div class="group relative">
            ...
            <button class="relative rounded-lg bg-black px-7 py-4 text-white">
            <h1 class="text-5xl p-4 text-center font-bold from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r bg-clip-text text-transparent">Welcome To React </h1>
            ...
            <Link to='https://react.dev/'><button class="App-button">Start learning now</button></Link>
          </div>
